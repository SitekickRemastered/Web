...
## **BETA 0.7.10**
#### Big Patch 2 - <small>December 1st, 2025</small>
Fixes and Features:
+ [Chipendium doesn't load outside of CHIPS tab](https://github.com/SitekickRemastered/Game/issues/99)
+ [Delete account doesn't wipe chipendium](https://github.com/SitekickRemastered/Game/issues/102)
+ [XP bar darkens when opening chip of the day](https://github.com/SitekickRemastered/Game/issues/105)
+ [Chip Dump Lag](https://github.com/SitekickRemastered/Game/issues/106)
+ [Rename still sends without changes](https://github.com/SitekickRemastered/Game/issues/107)
+ [Taking dumped chip does not wait for transaction complete](https://github.com/SitekickRemastered/Game/issues/108)
+ [Special dialog works on alts](https://github.com/SitekickRemastered/Game/issues/110)
