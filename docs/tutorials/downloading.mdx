---
sidebar_label: Downloading the Game
---
...
<details className="alert--success">
    <summary>Microsoft Store (Windows 10/11)</summary>
...
<details className="alert--success">
    ...
    **Installing Sitekick Remastered**
    ...
    1. Go to our [GitHub releases page](https://github.com/SitekickRemastered/Game/releases/) and download the `Linux_<version>.tar.gz` file 
    2. Extract the contents to the destination of your choice.
    3. Open the folder and run `SitekickRemastered_<version>.x86_64`
</details>
...
<details className="alert--success">
    <summary>iOS (iPhone/iPod/iPad)</summary>
