---
sidebar_label: How to Use SitePic
---

# How to use SitePic

<div style={{ textAlign: "center", marginTop: "10px" }}>
  <video width="80%" height="80%" controls className="d-flex m-auto">
    <source src="https://user-images.githubusercontent.com/1341176/284038916-04a8aa75-7cce-4161-b416-b7bead119d3f.mp4" type="video/mp4" />
  </video>
  <figcaption style={{ fontStyle: "italic", marginTop: "8px" }}>SitePic is a Discord bot that generates user profile pictures via private messages.</figcaption>
</div>
...
# Brief Tutorial:
:::discord
You need to join the Sitekick Remastered [Discord Server](https://discord.sitekickremastered.com) to use SitePic.
:::
