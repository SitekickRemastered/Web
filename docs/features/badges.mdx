...
:::info
During the Beta, many badges are disabled due to lack of balancing.  More badges will become available in version 1.0.
:::

## Confirmed Badges
| Icon | Name | Description | Multiple Allowed | Levels Up |
| :---: | :---: | :---: | :---: | :---: |
| ![verified.png](/img/wiki/features/badges/verified.png) | Verified | `{player}` has linked their account to Discord. | No | No |
...
| <FAIcon icon="fa-solid fa-notdef" size="2x" /> | CotD Streak | `{#}` day "Chip of the Day" streak. | No | No |
